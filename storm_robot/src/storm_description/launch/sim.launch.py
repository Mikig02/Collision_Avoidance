...
def generate_launch_description():
    ...
    spawn_robot = Node(
        package='ros_gz_sim',
        executable='create',
        # arguments=['-topic', 'robot_description', # Spawn position test map 3
        #    '-name', 'storm',
        #    '-x', '-0.16', 
        #    '-y', '0.04', 
        #    '-z', '1.5', 
...
arguments=[ # Spawn Mappa 1 
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/world/test_map_1/control@ros_gz_interfaces/srv/ControlWorld',
            '/world/test_map_1/set_pose@ros_gz_interfaces/srv/SetEntityPose',
        ],
